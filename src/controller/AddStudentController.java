...
public class AddStudentController implements Initializable,LibraryElement {
    private double xOffset = 0;
    private double yOffset = 0;

    ObservableList<String> yearListBox = FXCollections.observableArrayList("1", "2", "3", "4");
    ObservableList<String> facultyListBox = FXCollections.observableArrayList("Math", "Physics", "Enigneering", "Computer Science", "Politics", "Chemistry");
