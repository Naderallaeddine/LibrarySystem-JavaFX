...
public class ReturnBookController implements Initializable {
    ...
    public void returnBook(ActionEvent event) throws IOException {
        if(searchBookCode.getText().isEmpty() || btitleTxt.getText().isEmpty() ||
        searchStudentID.getText().isEmpty() || bpriceTxt.getText().isEmpty() ||  bcategoryTxt.getText().isEmpty()
        ||  bpublisherTxt.getText().isEmpty() || beditionTxt.getText().isEmpty() ||  stNameTxt.getText().isEmpty()
        ||  stYearTxt.getText().isEmpty() ||   stMajorTxt.getText().isEmpty() ||stEmailTxt.getText().isEmpty()
        ||  stDepartmentTxt.getText().isEmpty()  || issueDateTxt.getText().isEmpty()
         ){
            Alert alert = new Alert(AlertType.ERROR, "All field must be filled", ButtonType.CANCEL);
alert.showAndWait();
         }else{
            returned();
            del();
    ...
    public void search() {
        ...
        try {
            ...
            if (rs.next()) {
                btitleTxt.setText(rs.getString(10));
                bpriceTxt.setText(rs.getString(11));
                bcategoryTxt.setText(rs.getString(12));
                bpublisherTxt.setText(rs.getString(13));
                beditionTxt.setText(rs.getString(14));
                searchStudentID.setText(rs.getString(3));
